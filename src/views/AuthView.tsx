...
export const AuthView: React.FC = () => {
  const { login, signup, googleLogin, authLoading } = useApp();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-brand-600/20 rounded-full blur-3xl pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="p-3 bg-brand-500/10 border border-brand-500/30 rounded-2xl mb-3 shadow-lg shadow-brand-500/5">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-xl font-semibold text-slate-100 mb-6 flex items-center justify-between">
            ...
            <span className="text-xs font-normal text-brand-400 px-2 py-1 bg-brand-500/10 border border-brand-500/20 rounded-md">
              Secure
            </span>
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-3 bg-slate-950 border border-slate-880 rounded-xl text-slate-100 placeholder-slate-550 text-sm focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all duration-200"
                />
              </div>
            </div>
            ...
            {isLogin && (
              <div className="flex items-center justify-between text-xs pt-1">
                <label className="flex items-center gap-2 text-slate-450 cursor-pointer">
                  <input
                    type="checkbox"
                    className="rounded bg-slate-950 border-slate-800 text-brand-500 focus:ring-brand-500/20 focus:ring-offset-slate-950"
                  />
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-500 hover:to-indigo-500 text-white font-medium py-3 px-4 rounded-xl shadow-lg shadow-brand-600/10 hover:shadow-brand-600/20 active:scale-[0.98] transition-all duration-200 mt-6"
            >
              {isLogin ? (
                <>
                  <span>Sign In</span>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900 px-2.5 text-slate-500 font-medium">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-50 text-slate-900 font-semibold py-3 px-4 rounded-xl border border-slate-200 shadow-sm transition-all duration-200 active:scale-[0.98] text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-slate-500 focus:ring-offset-slate-900"
          >
